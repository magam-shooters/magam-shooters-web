    ...
    <div className="bg-white">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <ModernSectionHeader
            subtitle="Our Federation"
            title="Leading Sri Lanka's Shooting Sports"
            description="The National Shooting Sports Federation of Sri Lanka (NSSF) is the apex body governing shooting sports in the country. We are dedicated to developing world-class athletes, promoting safe shooting practices, and fostering a culture of excellence in marksmanship across the nation."
          />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            {/* Content */}
            <div>
              <h3 className="font-sans text-3xl font-semibold mb-6" style={{ color: colors.primary.navy }}>Our Mission</h3>
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  className="font-sans px-6 py-3 rounded-lg font-semibold text-white transition-all duration-200 hover:shadow-lg"
                  style={{ backgroundColor: colors.primary.navy }}
                >
                  Our Programs
                </button>
                <button
                  className="font-sans px-6 py-3 rounded-lg font-semibold transition-all duration-200 hover:shadow-lg border-2"
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="font-sans text-2xl font-semibold mb-4" style={{ color: colors.primary.navy }}>Our Vision</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="font-sans text-2xl font-semibold mb-4" style={{ color: colors.primary.navy }}>Our Mission</h3>
                  <p className="font-sans text-gray-700 text-base leading-relaxed">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <ModernSectionHeader
            ...
            title="Core Values"
            description="The fundamental principles that guide our federation and shape the future of shooting sports in Sri Lanka"
          />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {coreValues.map((value, index) => {
              ...
              return (
                <div
                  key={value.title}
                  className="bg-linear-to-br from-white to-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100"
                >
                  <div className="mb-6">
                  ...
                  <h3 className="font-sans text-xl font-semibold mb-3" style={{ color: colors.primary.navy }}>
                    {value.title}
                  </h3>
      ...
      <section className="bg-linear-to-b from-gray-50 to-white py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <ModernSectionHeader
            className="mb-12"
            subtitle="Our Impact"
            title="Achievements & Milestones"
            description="Decades of excellence in developing shooting sports talent and representing Sri Lanka internationally"
          />
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <ModernSectionHeader
            subtitle="Excellence in Every Shot"
            title="Why Choose NSSF Sri Lanka"
            description="Leading the nation with world-class facilities, expert coaching, and a commitment to athlete success"
          />

          <div className="grid md:grid-cols-2 gap-8">
            {/* Feature 1 */}
            <div className="flex gap-6 p-6 bg-linear-to-br from-white to-gray-50 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="shrink-0">
                <div className="w-16 h-16 rounded-lg flex items-center justify-center" style={{ backgroundColor: colors.primary.yellow }}>
              ...
              <div>
                <h3 className="font-sans text-xl font-semibold mb-2" style={{ color: colors.primary.navy }}>Olympic-Level Training</h3>
                <p className="font-sans text-gray-600 leading-relaxed">
            ...
            <div className="flex gap-6 p-6 bg-linear-to-br from-white to-gray-50 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <div>
                <h3 className="font-sans text-xl font-semibold mb-2" style={{ color: colors.primary.navy }}>World-Class Facilities</h3>
                <p className="font-sans text-gray-600 leading-relaxed">
            ...
            <div className="flex gap-6 p-6 bg-linear-to-br from-white to-gray-50 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <div>
                <h3 className="font-sans text-xl font-semibold mb-2" style={{ color: colors.primary.navy }}>Uncompromising Safety</h3>
                <p className="font-sans text-gray-600 leading-relaxed">
            ...
            <div className="flex gap-6 p-6 bg-linear-to-br from-white to-gray-50 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <div>
                <h3 className="font-sans text-xl font-semibold mb-2" style={{ color: colors.primary.navy }}>Nationwide Network</h3>
                <p className="font-sans text-gray-600 leading-relaxed">
      ...
      <section className="py-20 px-4 bg-linear-to-br from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="font-sans text-4xl md:text-5xl font-bold mb-6">Join the NSSF Family</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              className="font-sans px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 hover:shadow-xl hover:scale-105"
              style={{ backgroundColor: colors.primary.yellow, color: colors.primary.navy }}
            >
              Become a Member
            </button>
            <button
              className="font-sans px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 hover:shadow-xl hover:scale-105 border-2 border-white text-white hover:bg-white hover:text-[#002B7F]"
            >
              Contact Us
            </button>
          </div>
