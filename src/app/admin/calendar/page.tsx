                  ...
                  <tr key={e._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
                        <button onClick={() => openEdit(e)} className="p-1.5 hover:bg-blue-50 rounded text-blue-600">✏️</button>
                        <button onClick={() => setDeleteId(e._id)} className="p-1.5 hover:bg-red-50 rounded text-red-500">🗑️</button>
                      </div>
                    </td>
                  </tr>
                ))}
