  ...
  return (
    <section className={`bg-white py-16 px-4 sm:px-6 lg:px-8 ${className}`}>
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-sans font-bold text-black mb-4">
          {title}
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
          <Link
            ...
            className={`inline-block font-sans font-bold py-3 px-8 transition duration-300 uppercase text-sm tracking-wider ${
