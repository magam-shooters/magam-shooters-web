    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4 bg-gray-50 p-3 rounded-lg">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-[#FFD100]">{result.winners.gold}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-600">🥈 Silver:</span>
                    <span className="text-sm font-bold text-gray-500">{result.winners.silver}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-600">🥉 Bronze:</span>
                    <span className="text-sm font-bold text-[#CD7F32]">{result.winners.bronze}</span>
                  </div>
                </div>
        ...
        <div className="text-center mt-12">
          <Link
            href="/results"
            className="inline-flex items-center gap-3 bg-[#D71920] hover:bg-[#A01520] text-white font-semibold py-3 px-8 rounded-full transition-all duration-300 hover:scale-105"
          >
            View All Results
            <FaArrowRight />
          </Link>
