    ...
    <section className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
                ...
                <div className="relative rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                    <div className="p-6 w-full">
                      ...
                      <h3 className="text-white text-xl font-montserrat font-bold">{image.title}</h3>
                    </div>
                  </div>
                </div>
              </button>
        ...
        <div className="text-center mt-8">
          <a
            href="/gallery"
            className="inline-block px-8 py-3 rounded-lg font-montserrat font-semibold text-white transition-all duration-200 hover:shadow-lg hover:scale-105"
        ...
        >
          <div className="relative max-w-5xl w-full">
            ...
            <div className="mt-4 text-white text-center">
              <h3 className="text-2xl font-montserrat font-bold mb-2">{selectedImage.title}</h3>
              <span
                className="inline-block px-4 py-2 rounded-full text-sm font-montserrat font-semibold"
                style={{
                  backgroundColor: colors.primary.yellow,
                  color: colors.primary.navy
                }}
