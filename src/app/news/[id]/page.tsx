      ...
      <div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8">The news article you're looking for doesn't exist or may have been removed.</p>
            <Link
              href="/news"
              className="inline-flex items-center gap-2 bg-[#002B7F] hover:bg-[#001B5F] text-white font-semibold py-3 px-6 rounded-lg transition duration-300"
            >
              <FaArrowLeft />
              Back to News
            </Link>
      ...
      <article className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="w-full h-64 sm:h-80 lg:h-96 bg-gradient-to-br from-[#002B7F] to-[#004A9F] rounded-xl flex items-center justify-center mb-8">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              ...
              <Link
                href="/news"
                className="inline-flex items-center gap-2 text-[#002B7F] hover:text-[#001B5F] font-semibold transition-colors"
              >
                <FaArrowLeft />
                Back to All News
              </Link>
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            <h3 className="text-2xl font-bold text-[#002B7F] mb-6">Related News</h3>
              ...
              {Object.values(newsData)
                ...
                .map((relatedNews) => (
                  ...
                  >
                    ...
                    <h4 className="font-bold text-[#002B7F] mb-2 line-clamp-2">{relatedNews.title}</h4>
